...
export function moduleGenerator(serviceName: string, nestjsSrcPath: string, idlProgram: IdlProgram) {
...
function createController(idlProgram: IdlProgram, serviceName: string, commandNames: string[], queryNames: string[]): ControllerData {
    const lines: string[] = [];
